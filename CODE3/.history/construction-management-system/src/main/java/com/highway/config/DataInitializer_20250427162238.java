...
public class DataInitializer {
    ...
    private void initializeSafetyRecords() {
        if (safetyRecordService.getAllRecords().isEmpty()) {
            // 创建一些安全记录
            ...
            record1.setHandler("张工");
            record1.setSolution("更换液压油，检修液压系统");
            ...
            record2.setHandler("李工");
            record2.setSolution("送医治疗，加强安全培训");
            ...
            record3.setHandler("王工");
            record3.setSolution("立即停止作业，检修设备，加强检查");
